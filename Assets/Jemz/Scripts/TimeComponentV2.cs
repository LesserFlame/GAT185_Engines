...
public class TimeComponentV2 : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (timeSpeed == 0)
		{
			...
			{
				Vector3 velocity;
				velocity.x = Mathf.Lerp(rb.velocity.x, timeSpeed, 0.2f);
				velocity.y = Mathf.Lerp(rb.velocity.y, timeSpeed, 0.2f);
				velocity.z = Mathf.Lerp(rb.velocity.z, timeSpeed, 0.2f);
			}
